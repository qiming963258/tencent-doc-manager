...
class IntelligentExcelMarker:
    ...
    def __init__(self):
        ...
        self.column_level_colors = {
            "L1": {"fg": "FFFF0000", "bg": "FFFF0000"},  # L1列(最重要) - 红色
            "L2": {"fg": "FFFFA500", "bg": "FFFFA500"},  # L2列(重要) - 橙色
            "L3": {"fg": "FF00FF00", "bg": "FF00FF00"}   # L3列(一般) - 绿色
        }
        
        # 备用：如果需要根据风险等级涂色
        self.risk_level_colors = {
            "EXTREME_HIGH": {"fg": "FFFF0000", "bg": "FFFF0000"},  # 极高风险 - 红色
            "HIGH": {"fg": "FFFFCCCC", "bg": "FFFFCCCC"},          # 高风险 - 浅红色
            "MEDIUM": {"fg": "FFFFE9E8", "bg": "FFFFE9E8"},        # 中风险 - 浅橙色
            "LOW": {"fg": "FFFFFF00", "bg": "FFFFFF00"}            # 低风险 - 黄色
        }
